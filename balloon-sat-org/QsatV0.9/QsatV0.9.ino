...
static int thread7_entry(struct pt *pt){             
  ...
  while(1){
    ...
    UHFout = "0TMP:"+(String)(airTemp)+" 1HUM:"+(String)(airHumility);
    UHFser.println(UHFout);
    UHFout = ""; 

    UHFout = "2bPRS:"+(String)(basePressure)+" 3PRS:"+(String)(pressure)+" 4ALT:"+(String)(BmpAltitude);
    UHFser.println(UHFout);
    UHFout = ""; 

    UHFout = "5DIS:"+(String)(distance)+" 6LAT:"+(String)(gpsData.latitude)+" 7LON:"+(String)(gpsData.longitude);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "8GALT:"+(String)(gpsData.altitude)+" 9NSAT:"+(String)(gpsData.sat)+" 10HDOP:"+(String)(gpsData.HDOP);
    UHFser.println(UHFout);
    UHFout = ""; 
    
    UHFout = "11fix:"+(String)(gpsData.fix)+" 12fixq:"+(String)(gpsData.fixq);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "13spd:"+(String)(gpsData.speed)+" 14bLat:"+(String)(baseLat)+" 15bLon:"+(String)(baseLon);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "16hour:"+(String)(gpsData.hour)+" 17min:"+(String)(gpsData.minu)+" 18sec:"+(String)(gpsData.sece);
    UHFser.println(UHFout);
    UHFout = "";
    UHFout = "19AX:"+(String)(data[19])+" 20AY:"+(String)(data[20])+" 21AZ:"+(String)(data[21])+" 31ACC:"+(String)(allAcc);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "22GX:"+(String)(data[22])+" 23GY:"+(String)(data[23])+" 24GZ:"+(String)(data[24]);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "25MX:"+(String)(data[25])+" 26MY:"+(String)(data[26])+" 27MZ:"+(String)(data[27]);
    UHFser.println(UHFout);
    UHFout = ""; 
    UHFout = "28PIT:"+(String)(data[28])+" 29ROL:"+(String)(data[29])+" 30YAW:"+(String)(data[30]);
    UHFser.println(UHFout);
    UHFout = ""; 

    UHFout = "c5S:"+(String)(time5S_cnt)+" bat:"+(String)(batteryVoltage)+" bH:"+(String)(bmpHight)+" gH:"+(String)(gpsHight);
    UHFser.println(UHFout);
    UHFout = ""; 
